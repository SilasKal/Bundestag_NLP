...
public class RestSchnittstelle {
  /**
   * @author Silas
   * starts restport to provide data for dashboard
   */
  public static void restStart() {
    get("/speeches/count", (req, res) -> {
      return getSpeechesCount("");
    });
...
//      System.out.println(counter);
  ...
  /**
   * @author copied from sparkjava.com
   * enables you to host server and make ajax-requests from the same machine
   */
